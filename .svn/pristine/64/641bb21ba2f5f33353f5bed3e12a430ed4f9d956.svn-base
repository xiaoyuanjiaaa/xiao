...
public class StringHelper {
	...
	public static String makeAllWordFirstLetterUpperCase(String sqlName) {
		sqlName = sqlName.replaceAll("ssms_", "");
	...
	/**
	 * 灏嗕竴涓暟鎹簱鍚嶇О杞崲涓�Java 鍙橀噺鍚嶇О,濡�user_info => userInfo
	 * @param sqlName
	 * @param singularize
	 * @return
	 */
	...
	/**
	 * 灏嗕竴涓暟鎹簱鍚嶇О杞崲涓�Java ClassName,濡�user_info => UserInfo
	 * @param sqlName
	 * @param singularize 鏄惁灏嗗鏁拌浆鎹负鍗曟暟,濡�customers => customer
	 * @return
	 */
	...
	/**锟斤拷锟斤拷母锟斤拷copy from spring*/
	public static String capitalize(String str) {
		return changeFirstCharacterCase(str, true);
	}

	/**锟斤拷锟斤拷母小写copy from spring*/
	...
	/**
	 * 灏唖tring杞崲涓篖ist<ColumnEnum> 鏍煎紡涓� "enumAlias(enumKey,enumDesc)"
	 */
	...
	/**
	 * 涓�鏌ヨsql涓殑鍏抽敭瀛�select鍚庨潰鎻掑叆涓�鍊�
	 **/
	...
	/**
	* 灏嗕竴涓崟璇嶄粠鍗曟暟杞彉涓哄鏁� 濡�customer => customers
	*/
	...
	/**
	 * 灏嗕竴涓崟璇嶄粠澶嶆暟杞彉涓哄崟鏁� 濡�customers => customer
	 */
